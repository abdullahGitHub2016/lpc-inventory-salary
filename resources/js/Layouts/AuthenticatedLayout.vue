            ...
            <nav class="border-b border-gray-100 bg-white">
                    ...
                    <div class="flex h-16 justify-between">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <NavLink :href="route('inventory.fleet')" :active="route().current('inventory.fleet')">
                                    Machine Management
                                </NavLink>
                                <NavLink :href="route('sites.index')" :active="route().current('sites.index')">
                                    Site Management
                                </NavLink>
                                <NavLink :href="route('advance-reasons.index')"
                                    :active="route().current('advance-reasons.index')">
                                    Advance Reasons
                                </NavLink>
                ...
                <div :class="{ 'block': showingNavigationDropdown, 'hidden': !showingNavigationDropdown }"
                    ...
                    <div class="space-y-1 pb-3 pt-2">
                        ...
                        <ResponsiveNavLink :href="route('inventory.fleet')"
                            :active="route().current('inventory.fleet')">
                            Fleet Management
                        </ResponsiveNavLink>
                    </div>
                    ...
                    <div class="border-t border-gray-200 pb-1 pt-4">
                        ...
                        <div class="px-4 text-sm font-medium text-gray-500">{{ $page.props.auth.user.email }}</div>
